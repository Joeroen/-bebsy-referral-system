      ...
      <nav style={{
        ...
        <div style={{maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 20px'}}>
          ...
          <div>
            ...
            <button style={{...buttonStyle, padding: '10px 20px', fontSize: '14px'}}>
              Inloggen
            </button>
          </div>
        </div>
      ...
      <section style={{...heroStyle, marginTop: '70px'}}>
        <div style={{maxWidth: '800px'}}>
          ...
          <div style={{marginBottom: '40px'}}>
            ...
            <button style={secondaryButtonStyle} onMouseOver={(e) => e.target.style.background = 'rgba(255,255,255,0.1)'} onMouseOut={(e) => e.target.style.background = 'transparent'}>
              Bekijk Demo
            </button>
          </div>
...
// Dashboard App Component (the app users see after login)
